...
export async function main(
  ...
  console.log("DEeeeeeeeeeeeDEeeeeeeeeeeeDEeeeeeeeeeeeDEeeeeeeeeeeeDEeeeeeeeeeeeDEeeeeeeeeeeeDEeeeeeeeeeeeDEeeeeeeeeeee")
...
async function wmill_sync_pull(
  ...
  await sh_run(undefined, 'cat', 'wmill.yaml')
