...
export async function main(approver1?: string, approver2?: string) {
  const urls1 = await wmill.getResumeUrls(approver1)
  const urls2 = await wmill.getResumeUrls(approver2)
  // send the urls to their intended recipients

  console.log(urls1, urls2)
  return {
